...
description: "Explore the space of possibilities by having AI produce multiple variations of a tagline, pitch, or message before you commit to a direction."
tags:
  - production + review
related_playbooks:
...
The trap is generating variations without knowing what you're looking for. Twenty options with no evaluation criteria just gives you a harder decision. Pair this with a [rubric](rubric-driven-assessment.md) and it gets much sharper.
...
This is where it connects to [rubric-driven assessment](rubric-driven-assessment.md). With twenty variations in front of you, gut feel alone isn't reliable. You'll gravitate toward the one closest to what you already had in mind, which defeats the purpose of generating options.
...
If you want, run the refined version through a [secondary AI review](secondary-ai-review.md) to catch any AI patterns that crept into the language.
...
- [Rubric Driven Assessment](rubric-driven-assessment.md) — Score variations against a rubric rather than picking on gut feel. This is what makes the process rigorous rather than just brainstorming.

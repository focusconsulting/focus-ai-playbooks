...
description: "Go from thesis to outline to filled content, keeping the human in control of the thinking at every stage."
tags:
  - production + review
related_playbooks:
...
This is a good place to bring in a [rubric](rubric-driven-assessment.md). If you built one for this type of document, score the draft against it. If you didn't, this might be the moment that convinces you to build one for next time.
...
If the document has been through a few rounds of revision, consider running it through a [secondary AI review](secondary-ai-review.md) to catch the AI-isms that accumulate: filler phrases, em-dashes everywhere, that characteristic symmetry where every paragraph has exactly three points.

## Related Playbooks

- [Rubric Driven Assessment](rubric-driven-assessment.md) — Score your document against a rubric at each stage. Catching structural issues at the outline stage is much cheaper than catching them in a finished draft.
- [Secondary AI Review](secondary-ai-review.md) — After iteration, use a fresh session to clean up AI writing patterns that crept in.

...
This repository uses multiple shared planning and research areas.

Please provide:
1. Your research question or area of interest
2. (Optional) Which product or area to focus on, such as `supper-client`, `prep-manager`, or another current repo area
...
3. **Spawn parallel sub-agent tasks for comprehensive research:**
   ...
   **For web research (only if user explicitly asks):**
   - Use OpenCode built-in web research tooling (for example `librarian` plus web tools) for external documentation and resources
...
5. **Gather metadata for the research document:**
   ...
   - Use an area that exists in this repository today, or `general/` for cross-cutting research
   - Format: `YYYY-MM-DD-description.md` where:
     - YYYY-MM-DD is today's date
     - description is a brief kebab-case description of the research topic
   - Examples:
     - `thoughts/shared/research/api/2025-01-22-authentication-flow.md`
     - `thoughts/shared/research/infrastructure/2025-01-22-terraform-modules.md`

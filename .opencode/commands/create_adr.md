...
ls thoughts/shared/adrs/ | grep -E '^[0-9]{4}-' | sort -r | head -1
...
Create the file at: `thoughts/shared/adrs/NNNN-short-title.md`
...
- `0003-use-sqlalchemy-orm.md`

Use the template from `thoughts/shared/adrs/0000-adr-template.md`:

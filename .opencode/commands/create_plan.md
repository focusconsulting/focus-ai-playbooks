...
1. **Check if parameters were provided**:
   ...
   - If an area was specified (for example `/create_plan supper-client #123`), note the area
...
This repository uses shared planning documents under `thoughts/shared/plans/`.

Please provide:
1. The task/issue description (GitHub issue #, beads ID, or plain description)
2. Which product or area this work affects (for example `supper-client`, `prep-manager`, or cross-cutting)
3. Any relevant context, constraints, or specific requirements

Tip: You can specify a likely area directly, for example `/create_plan supper-client #123`.
```
...
1. **Write the plan** to `thoughts/shared/plans/<area>/YYYY-MM-DD-issue-XXX-description.md`
   - Use an area that exists in this repository today, such as `supper-client`, `prep-manager`, or a cross-cutting shared area.
   - Format: `YYYY-MM-DD-issue-XXX-description.md` where:
    ...
    - Examples:
      - Product feature: `thoughts/shared/plans/supper-client/2025-01-22-issue-123-user-authentication.md`
      - Service feature: `thoughts/shared/plans/prep-manager/2025-01-22-bd-a1b2-menu-sync.md`
      - Cross-cutting: `thoughts/shared/plans/general/2025-01-22-issue-456-ci-cd-pipeline.md`
...
- **Area**: [product/service/shared area in current repository]
...
**File**: `path/from/repo/root.ext` (note: use the actual full path from repo root)
...
- [ ] Use the actual build/test/typecheck commands that apply to the files touched in this repository
- [ ] Prefer commands already used by existing package scripts, CI, or neighboring code
- [ ] Record concrete commands in the plan instead of assuming generic area-level scripts
